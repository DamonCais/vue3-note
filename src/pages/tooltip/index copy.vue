...
<template>
  <div class="w-200px h-300px">
    <div class="bg-gray-2 w-100px h-500px"></div>
    <div @clickoutside="handleClickOutside" @mouseenter="handleTriggerEnter" @mouseleave="handleTriggerLeave" ref="wrapper">
      <div @click="test" class="bg-green" ref="reference">reference</div>
      <teleport to='body'>
